...
public final class MarquezContext {
  ...
  @Getter private final NuHealthCheckResource nuHealthCheckResource;
  ...
  private MarquezContext(
    ...
    this.nuHealthCheckResource = new NuHealthCheckResource(serviceFactory);
